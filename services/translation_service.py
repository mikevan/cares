...
def _segment_translation_prompt(marked_html: str, language_name: str,
    ...
    return _page_preamble(marked_html) + _range_clause(batch, total) + (
        ...
        f'- Many strings begin with an account number and a dash, like '
        f'"1420 - Furniture & Fixtures". Keep that prefix exactly as it is, dash '
        f'included, and translate only the words after it. The code is not language.\n'
